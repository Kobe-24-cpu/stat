...
interface MediaItem {
  ...
  type: "video" | "photo";
  src: string;
  poster?: string; // Image d'attente pour les vidéos
  title: string;
}
...
export default function Home() {
  ...
  return (
    <div style={{ background: "#1C1917", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", color: "#F5F5F4" }}>
      ...
      {/* ── MODAL LIGHTBOX / INTERFACE PLEIN ÉCRAN ── */}
      {activeMedia && (
        <div
      ...
      <section style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px 80px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
          ...
          <Link href="/joueurs" style={{
            fontSize: 13, color: "#F97316", textDecoration: "none", fontWeight: 600,
            border: "1px solid rgba(249,115,22,0.3)", padding: "8px 16px", borderRadius: 8,
          }}>
            + Ajouter un joueur
          </Link>
        </div>
        ...
        {joueurs.length === 0 ? (
          <div style={{ background: "#2C2925", border: "1px dashed rgba(255,255,255,0.1)", borderRadius: 16, padding: 60, textAlign: "center" }}>
            ...
            <Link href="/joueurs" style={{
              display: "inline-block", marginTop: 20, background: "#F97316",
              color: "white", padding: "10px 24px", borderRadius: 8, textDecoration: "none",
              fontWeight: 700, fontFamily: "'Barlow Condensed', sans-serif", fontSize: 16, letterSpacing: 1,
            }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 16 }}>
            {joueurs.map((j) => (
              <div key={j.id} style={{
                ...
                <div style={{
                  width: 52, height: 52, borderRadius: "50%", background: "#FED7AA",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 18, color: "#C2410C", flexShrink: 0,
                }}>
                  {j.prenom[0] || ""}{j.nom[0] || ""}
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ marginTop: 4 }}>
                    <span style={{
                      ...
                      background: `${POSTE_COLORS[j.poste] || "#444"}22`,
                      color: POSTE_COLORS[j.poste] || "#fff",
